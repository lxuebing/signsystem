...
Component.options.__file = "G:\\PhpStudy\\PHPTutorial\\WWW\\signsystem\\resources\\assets\\js\\components\\wechat\\course\\Count.vue"
  ...
  methods: {
    ...
    setHasNoCourse: function setHasNoCourse(bool) {
      ...
      if (this.haveNoCourse) {
        for (var i = 0; i < this.haveCourse.length; i++) {
          this.courses.push(this.haveCourse[i]);
        }
      } else {
        for (var _i = 0; _i < this.noCourse.length; _i++) {
          this.courses.push(this.noCourse[_i]);
        }
      }
    },
    ...
    setNowWeek: function setNowWeek() {
      ...
      var translate = (this.get.nowWeek - 3) * -40;
    ...
    getCourses: function getCourses() {
      ...
      this.noCourse = [];
      for (var i = 0; i < 7; i++) {
        this.haveCourse[i] = [{ id: '1-2', stus: [] }, { id: '3-4', stus: [] }, { id: '5', stus: [] }, { id: '6-7', stus: [] }, { id: '8-9', stus: [] }, { id: '10-11', stus: [] }, { id: '12', stus: [] }];
        this.noCourse[i] = [{ id: '1-2', stus: [] }, { id: '3-4', stus: [] }, { id: '5', stus: [] }, { id: '6-7', stus: [] }, { id: '8-9', stus: [] }, { id: '10-11', stus: [] }, { id: '12', stus: [] }];
      }
      var all = this.get.students,
          //所有用户信息
      ...
      for (var _i2 in selStu) {
        //循环选中用户
        for (var course in all[selStu[_i2].id].courses) {
          // 循环用户的课表
          var tempCourse = all[selStu[_i2].id].courses[course];
            ...
            for (var n = tempCourse.start_section; n <= tempCourse.end_section; n++) {
              ...
              if (sectionNum !== -1) {
                this.haveCourse[tempCourse.week_day - 1][sectionNum].stus.push({
                  id: selStu[_i2].id,
                  name: selStu[_i2].name,
                  courseInfo: tempCourse.name + '/' + tempCourse.location
                });
                if (!(sectionNum === 5 || sectionNum === 12)) continue;
              }
            }
          }
        }
      ...
      for (var _i3 = 0; _i3 < 7; _i3++) {
        for (var j = 0; j < 7; j++) {
          var tmpStus = this.haveCourse[_i3][j].stus;
    ...
    courseInfo: function courseInfo(user_id, _courseInfo) {
      this.selUserId = user_id;
      if (this.haveNoCourse) {
        this.$vux.toast.text(_courseInfo, 'top');
      }
    },
...
Component.options.__file = "G:\\PhpStudy\\PHPTutorial\\WWW\\signsystem\\node_modules\\vux\\src\\components\\popup\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "G:\\PhpStudy\\PHPTutorial\\WWW\\signsystem\\node_modules\\vux\\src\\components\\x-table\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
Component.options.__file = "G:\\PhpStudy\\PHPTutorial\\WWW\\signsystem\\node_modules\\vux\\src\\components\\check-icon\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.type ? '统计' : '课表'))])]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("高级筛选")])], 1)])], 1), _vm._v(" "), _c('carousel-3d', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.type),
  ...
  }, _vm._l((_vm.week_day), function(v, i) {
    return _c('slide', {
      key: i,
      staticClass: "week-day",
      style: ({
        backgroundColor: _vm.colors[_vm.colorIndex[i]].content
      }),
      attrs: {
        "index": i
      }
      ...
      style: ({
        backgroundColor: _vm.colors[_vm.colorIndex[i]].title
      })
    }, [_vm._v("\n                " + _vm._s(v) + "（"), _c('span', {
      on: {
        "click": function($event) {
    ...
    }, [_vm._v(_vm._s(_vm.haveNoCourse ? '有课' : '无课'))]), _vm._v("）\n            ")]), _vm._v(" "), _c('div', {
      staticClass: "courseContent"
    }, _vm._l((_vm.courses[i]), function(section) {
      return _c('div', {
        staticClass: "section",
        staticStyle: {
          "width": "100%"
        ...
        return _c('label', {
          ...
          on: {
            "click": function($event) {
              _vm.courseInfo(stu.id, stu.courseInfo)
            }
          }
    ...
    style: ({
      backgroundColor: _vm.haveNoCourse ? '#1AAD19' : '#E64340',
      color: 'white',
      borderRadius: '10px'
    }),
    on: {
  ...
  }, [_c('span', [_vm._v(_vm._s(_vm.haveNoCourse ? '有课' : '无课'))])]), _vm._v(" "), _c('th', [_vm._v("周一")]), _vm._v(" "), _c('th', [_vm._v("周二")]), _vm._v(" "), _c('th', [_vm._v("周三")]), _vm._v(" "), _c('th', [_vm._v("周四")]), _vm._v(" "), _c('th', [_vm._v("周五")]), _vm._v(" "), _c('th', [_vm._v("周六")]), _vm._v(" "), _c('th', [_vm._v("周日")])])]), _vm._v(" "), _c('tbody', _vm._l((7), function(i) {
    return _c('tr', [_c('td', [_vm._v(_vm._s((_vm.courses.hasOwnProperty(i - 1) && _vm.courses[i - 1].hasOwnProperty(0) && _vm.courses[i - 1][0].hasOwnProperty('id')) ? _vm.courses[0][i - 1].id : 0) + "节")]), _vm._v(" "), _vm._l((7), function(j) {
      return _c('td', {
        on: {
          "click": function($event) {
            _vm.selTd(j - 1, i - 1)
      ...
      }, [_vm._v("\n                    " + _vm._s((_vm.courses.hasOwnProperty(j - 1) && _vm.courses[j - 1].hasOwnProperty(i - 1) && _vm.courses[j - 1][i - 1].hasOwnProperty('stus')) ? _vm.courses[j - 1][i - 1].stus.length : 0) + "\n                ")])
    })], 2)
  }))]), _vm._v(" "), _c('div', {
    directives: [{
      name: "transfer-dom",
  ...
  }, _vm._l(((_vm.courses.hasOwnProperty(_vm.type2Data.x) && _vm.courses[_vm.type2Data.x].hasOwnProperty(_vm.type2Data.y) && _vm.courses[_vm.type2Data.x][_vm.type2Data.y].hasOwnProperty('stus')) ? _vm.courses[_vm.type2Data.x][_vm.type2Data.y].stus : []), function(stu, index) {
    return _c('label', {
      class: {
        'sel-user': stu.id === _vm.selUserId
      },
